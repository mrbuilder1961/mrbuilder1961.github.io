...
// variables were in index.html but weren't loading for some reason so i moved em here
...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		new Game.Upgrade('Revoke Elder Covenant',loc("You will get %1% of your CpS back, but the grandmatriarchs will return.",5)+'<q>we<br>rise<br>again</q>',6666666666, customCovenantIcon(true) ,function() //! MOD
		{
	...
	Game.Draw=function()
	{
		...
		if (!Game.OnAscend)
		{
			...
			if(EN) //! MOD
				str = addCookiesPerClick(Game, str); //! MOD
			else
