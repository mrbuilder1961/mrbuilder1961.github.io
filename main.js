...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		l('versionNumber').innerHTML='v. '+(parseFloat(Game.version)===2.042?"2.042 (fake)":Game.version)+'<div id="httpsSwitch" style="cursor:pointer;display:inline-block;background:url(img/'+(Game.https?'lockOn':'lockOff')+'.png);width:16px;height:16px;position:relative;top:4px;left:0px;margin:0px -2px;"></div>'+(Game.beta?' <span style="color:#ff0;">beta</span>':'');
