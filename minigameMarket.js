...
M.launch=function()
{
	...
	M.init=function(div)
	{
		...
		'.bankViewHide{position:absolute;z-index:10;width:14px;height:14px;background:url(img/tinyEyeOn.png);top:1px;right:4px;opacity:0.8;}'+
		'.bankHidden .bankViewHide{background:url(img/tinyEyeOff.png);}'+
